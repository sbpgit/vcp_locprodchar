		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Location Product Characteristics",
									"targetURL": "#cpappvcplocprodchar-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"cpappvcplocprodchar-display": {
								"semanticObject": "cpappvcplocprodchar",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=cpapp.vcplocprodchar",
									"url": sap.ui.require.toUrl("cpapp/vcplocprodchar")
								}
							}
						}
					}
